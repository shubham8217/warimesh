...
void main() {
      ...
      switch (call.method) {
        case 'getModelInfo':
          return <String, Object?>{
            'exists': true,
            'path': '/data/user/0/com.example.warimesh/files/llm/gemma-3n-e2b-it-int4.litertlm',
  ...
  test('prompt in → streamed reply out through LlmService.generate()', () async {
    ...
    expect(reply, 'For heatstroke: move to shade, cool with water, and seek help.');
